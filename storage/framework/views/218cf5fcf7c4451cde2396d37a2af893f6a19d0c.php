...
<img src="https://source.unsplash.com/2000x300" class="img-fluid" alt="...">
    <div class="container">
        <div class="row">
            <div class="col-10">

                <h1  class="mt-5">About Me</h1>
                <div>Hallo, nama saya Ricky Manuelee dengan NIM 2440076892 dari jurusan Computer Science Universitas Bina Nusantara.</div>
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BINUS\Sem 5\Web Prog\LEC\Forum\Forum 1\GSLC Blade Feature\GSLC1\resources\views/about.blade.php ENDPATH**/ ?>